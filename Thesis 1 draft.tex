...
\begin{enumerate}
 \item A change analysis project
\end{enumerate}
...
\begin{figure}[ht]
\centerline{\includegraphics[width=\linewidth]{"Figure 13".png}}
\caption{The K2 Framework}
\label{Figure 13}
\end{figure}
